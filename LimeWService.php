...
/*
  // $response = databasschema($client);
  // $response = tableschema($client);
  $response = companypost($client);
  // $response = insertcompanypost($client);
  debug($client);
  echo "<br />------------RESPONCE DATA----------<br />";
  echo var_dump($response->GetXmlQueryDataResult);
 */